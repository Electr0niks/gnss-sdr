/*!
 * \file sbas_l1_ca_pcps_acquisition.cc
...
SbasL1CaPcpsAcquisition::SbasL1CaPcpsAcquisition(
...
void SbasL1CaPcpsAcquisition::stop_acquisition()
{
    acquisition_->set_active(false);
}


void SbasL1CaPcpsAcquisition::set_threshold(float threshold)
{
...
void SbasL1CaPcpsAcquisition::set_doppler_max(unsigned int doppler_max)
{
...
void SbasL1CaPcpsAcquisition::set_doppler_step(unsigned int doppler_step)
{
...
void SbasL1CaPcpsAcquisition::set_doppler_center(int doppler_center)
{
...
void SbasL1CaPcpsAcquisition::set_gnss_synchro(Gnss_Synchro* gnss_synchro)
{
...
signed int SbasL1CaPcpsAcquisition::mag()
{
    return acquisition_->mag();
}


void SbasL1CaPcpsAcquisition::init()
{
    acquisition_->init();
}


void SbasL1CaPcpsAcquisition::set_local_code()
{
...
void SbasL1CaPcpsAcquisition::reset()
{
    acquisition_->set_active(true);
}


void SbasL1CaPcpsAcquisition::set_state(int state)
{
    acquisition_->set_state(state);
}


void SbasL1CaPcpsAcquisition::connect(gr::top_block_sptr top_block)
{
...
void SbasL1CaPcpsAcquisition::disconnect(gr::top_block_sptr top_block)
{
    if (item_type_ == "gr_complex" || item_type_ == "cshort")
        {
...
gr::basic_block_sptr SbasL1CaPcpsAcquisition::get_left_block()
{
    if (item_type_ == "gr_complex" || item_type_ == "cshort")
        {
            return acquisition_;
...
gr::basic_block_sptr SbasL1CaPcpsAcquisition::get_right_block()
{
    return acquisition_;
}


void SbasL1CaPcpsAcquisition::set_resampler_latency(uint32_t latency_samples)
{
